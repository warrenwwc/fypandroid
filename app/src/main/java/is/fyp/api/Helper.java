...
public class Helper {
    ...
    public String getEndpoint() {
        ArrayList<String> mints = new ArrayList<>(Arrays.asList("https://mint4.coms.hk/", "https://mint1.coms.hk/", "https://mint2.coms.hk/", "https://mint3.coms.hk/"));
        String[] mintPublicKey = {
                "",
        ...
        for (String mint : mints) {
            try {
                Response response = new OkHttpClient.Builder()
                        ...
                        .build().newCall(requestBuilder.url(mint + "queue").build()).execute();
